...
Add patterns directly in your `settings.json` (see the [settings reference](/logscope/reference/settings/) for all watch pattern fields):
...
- **From the Command Palette:** Run [`LogScope: Remove Watch Pattern`](/logscope/reference/commands/) and select the pattern to remove.
