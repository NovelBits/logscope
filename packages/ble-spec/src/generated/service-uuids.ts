...
// Source: packages/ble-spec/data/sig-mirror/service_uuids.yaml
...
// Upstream: https://bitbucket.org/bluetooth-SIG/public/raw/main/assigned_numbers/uuids/service_uuids.yaml
// Last updated: 2026-05-14
// Upstream commit: ad6172938054

export const SERVICE_UUIDS: Record<number, string> = {
  0x1800: "GAP",
  0x1801: "GATT",
...
export function lookupServiceUuid(code: number): string | null {
  return SERVICE_UUIDS[code] ?? null;
}
