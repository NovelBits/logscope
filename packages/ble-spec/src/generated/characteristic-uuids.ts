...
// Source: packages/ble-spec/data/sig-mirror/characteristic_uuids.yaml
...
// Upstream: https://bitbucket.org/bluetooth-SIG/public/raw/main/assigned_numbers/uuids/characteristic_uuids.yaml
// Last updated: 2026-05-14
// Upstream commit: ad6172938054

export const CHARACTERISTIC_UUIDS: Record<number, string> = {
  0x2A00: "Device Name",
  0x2A01: "Appearance",
...
export function lookupCharacteristicUuid(code: number): string | null {
  return CHARACTERISTIC_UUIDS[code] ?? null;
}
